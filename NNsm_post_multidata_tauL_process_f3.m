%% Script to estimate tauL of reanalysis data
 ...
 yrlist={'2002','2003','2004','2005','2006','2007','2008','2009','2010','2011',...
 ...
 for d = 1:length(yrlist)
     load(['./NNsm_tauL_f3_',yrlist{d},'.mat']);
...
%      filename = ['/home/xyw/matlabcode/nnsm_layer1/NNsm_mdata_tauL_f3_',yrlist{d},'.mat'];
%      save(filename,'lamuda_allm', 'thetaf_allm', ...
%                    'psm_allm','R2_allm',...
%                    'dd_st_allm','dd_end_allm','tau_allm',...
%                    'count_allm','tot_ET_II_allm','-v7.3');
      filename = ['/home/xyw/matlabcode/nnsm_layer1/NNsm_tot_ET_II_all_f3_',yrlist{d},'.mat'];
